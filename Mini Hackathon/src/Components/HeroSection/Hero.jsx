        ...
        <Grid container spacing={6} alignItems="center">
          ...
          <Grid item xs={12} md={8}>
            ...
            >
              ...
              and special celebrations — a place where every bite feels like a celebration.
            </Typography>
          ...
          {!isMobile && (
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                <Box sx={{ textAlign: "center", color: "rgba(255,255,255,0.85)" }}>
                  ...
                  <Typography variant="body1">🎂 Complimentary dessert on birthdays</Typography>
                </Box>
              </Box>
            </Grid>
          )}
